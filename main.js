    ...
    .then(data => {
        data.forEach(post => {
            ...
            if (oldKolo.className == "kolo-item active") {
                ...
                <div class="item-more">
                <button class="site" data-id="${post.id}">Więcej...</button>
                <button class="item-recrutation" disabled>Rekrutacja</a>
                </div>
                `; 
            }
...
const goToSite = (e) => {
    ...
    .then (data => {
        ...
        <div class="title">
            <img class="photo-open" src="images/${post.picture}" width="300px" height="200px" alt="">
            <h1>${post.name}</h1>
        </div>
        <div class="articlepi">
        ...
        <div class="title">
            <section class="photo">
            <img class="photo-open" src="images/${post.picture}" width="300px" height="200px" alt="photo">
            </section>
            <h1>${post.name}</h1>
        </div>
        <div class="articlepi">
            ...
            <section class="rec">
                ...
                <a class="btn" href="recrutation.php">Rekrutacja</a>
            </section>
        </div>
        </main>
                `;
